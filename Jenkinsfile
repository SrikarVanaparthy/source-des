                    ...
                    for (host in targetHosts) {
                        ...
                        parallelSteps["Transfer to ${cleanHost}"] = {
                            pwsh """
                                ...
                                Add-Content -Path "logs/transfer_${cleanHost}.log" -Value "===== Transfer Start to ${cleanHost} ====="
                                ...
                                ./migrate.ps1 `
                                    ...
                                    >> "logs/transfer_${cleanHost}.log" 2>&1

                                Add-Content -Path "logs/transfer_${cleanHost}.log" -Value "===== Transfer End to ${cleanHost} ====="
                            """
                        }
                    }
    ...
    post {
        always {
            ...
            emailext(
                ...
                body: """
<p>Job Result: ${currentBuild.currentResult}</p>
